...
class TestController {
   ...
   static allowedMethods = [save: "POST", update: "PUT", delete: "DELETE" ,checkForFirstName:"POST"]
	...
	def checkForFirstName(String firstName,String lastName) {
		def test = Test.findByTestFirstName(firstName)
		log.info "checkForFirstName method is called:"+lastName
		
		if(test!=null){
			log.info "Found value:"+test.testFirstName
			render(contentType: "application/json") {
				//msg(firstName: test.testFirstName)
				test
				}
			}
		else{
