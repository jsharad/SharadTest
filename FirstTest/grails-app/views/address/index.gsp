		...
		<div id="list-address" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="address.employee.label" default="Employee" /></th>
					
						<g:sortableColumn property="pin" title="${message(code: 'address.pin.label', default: 'Pin')}" />
				...
				<g:each in="${addressInstanceList}" status="i" var="addressInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: addressInstance, field: "employee")}</td>
					
						<td>${fieldValue(bean: addressInstance, field: "pin")}</td>
